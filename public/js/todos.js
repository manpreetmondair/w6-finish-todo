...
function showTodo(todo) {
   ...
   <li class="list-group-item"> 
    <div class="checkbox" id="check"><label> <input type="checkbox" data-id="${todo.id}" ${todo.completed === 'yes' ? 'checked' : ''} />${todo.todo}</label>
    <span class=" float label label-danger">${moment(todo.due_date).format('MM/DD/YYYY')}</span> 
